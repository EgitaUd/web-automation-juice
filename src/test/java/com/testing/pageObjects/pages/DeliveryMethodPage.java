...
public class DeliveryMethodPage extends AddressSelectPage {
  ...
  public static By ROW_ITEMS = css("body > app-root > div > mat-sidenav-container > mat-sidenav-content > app-delivery-method > mat-card > div:nth-child(4) > mat-table > mat-row");
  public static By CONTINUE_BUTTON = css("button[aria-label='Proceed to delivery method selection']");
  // Public methods
  // -------------------------------------------------------------------------------------------------------------------
